	...
	function f(a, b) {
		...
		for (p in b)
			if (void 0 === x.objects[p]) {
				...
				} else "DirectionalLight" === q.type || "PointLight" === q.type || "AmbientLight" === q.type ? (v = void 0 !== q.color ? q.color : 12632256, z = void 0 !== q.intensity ? q.intensity : 1, "DirectionalLight" === q.type ? (g = q.direction,
...
THREE.LineBasicMaterial = function (a) {
	...
	this.color = new THREE.Color(12632256);
	this.linewidth = 1;
...
THREE.MeshLambertMaterial = function (a) {
	THREE.Material.call(this);
	this.color = new THREE.Color(12632256);
	this.ambient = new THREE.Color(12632256);
...
THREE.UniformsLib = {
	...
	fog: {
		...
		fogColor: {
			type: "c",
			value: new THREE.Color(12632256)
		}
	},
	lights: {
		ambientLightColor: {
...
THREE.WebGLRenderer = function (a) {
	...
	this.renderBufferDirect = function (a, b, c, d, e, f) {
		if (!1 !== d.visible)
			if (c = A(a, b, c, d, f), a = c.attributes, b = !1, c = 12632256 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), c !== ka && (ka = c, b = !0), b && l(), f instanceof THREE.Mesh)
	...
	this.renderBuffer = function (a, b, c, d, e, f) {
		if (!1 !== d.visible) {
			var g, i, c = A(a, b, c, d, f),
				a = c.attributes,
				b = !1,
				c = 12632256 * e.id + 2 * c.id + (d.wireframe ? 1 : 0);
			c !== ka && (ka = c, b = !0);
			b && l();
...
THREE.LensFlare.prototype.add = function (a, b, c, d, e, f) {
	...
	void 0 === c && (c = 0);
	void 0 === f && (f = 1);
	void 0 === e && (e = new THREE.Color(12632256));
